...
import {
  IonicPage,normalizeURL, NavController, NavParams, ActionSheetController, LoadingController, ModalController, Platform,
...
declare var cordova:any;// 导入第三方的库,定义到TS项目中
...
export class HeadfacePage extends BaseUI{
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public actionSheetCtrl: ActionSheetController, public modalCtrl: ModalController,
              public storage: Storage, public loadCtrl: LoadingController, public rest:RestProvider, private camera: Camera, private file: File,
              private filePath: FilePath,private transfer: FileTransfer,public platform: Platform,public toastCtrl:ToastController,public viewCtrl: ViewController) {
    super();
  }
